        ...
        <div className='container'>
            <div className='d-flex justify-content-around align-items-center mt-4'>
                ...
                <div className='search'>
                    <input style={{ backgroundColor:'rgb(239, 239, 239)', marginRight: '1px', width: '300px' }} className='rounded-end red-input rounded-pill border border-1 p-2 ps-3' placeholder='Search...' type="search" name="" id="search-bar" />
            ...
            <div className='d-flex justify-content-between mt-4 mx-5 border-top border-2'>
                <div className='d-flex'>
                    <h6 className='mx-4 fw-bold nav-menu pt-3'>HOME</h6>
                    <h6 className='mx-4 fw-bold nav-menu pt-3'>CATEGORIES <i class="fas fa-angle-down text-secondary"></i></h6>
                    <h6 className='mx-4 fw-bold nav-menu pt-3'>BLOG</h6>
                    <h6 className='mx-4 fw-bold nav-menu pt-3'>ABOUT US</h6>
                </div>
                <div>
                    <h6 style={{color:'darkorchid', cursor:'pointer'}} className='fw-bold me-5 pt-3'>SPECIAL OFFER !</h6>
                </div>
            </div>
        </div>
    );
